...
function ajaxSendDataWithLoadingGetData(pData, pUrl, pLoadingElement, pOKfunction) {
...
function ajaxPartialView(pData, pUrl, pLoadingElement, pLoadPartialElement, pOKfunction) {
    if (typeof pData === 'object') {
        pData = JSON.stringify(pData);
    }
    if (pLoadingElement !== null) var loading = new ajaxLoader(pLoadingElement, { classOveride: 'blue-loader' });
